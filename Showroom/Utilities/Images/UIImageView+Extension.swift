...
extension UIImageView {
    ...
    func setImage(url: URL, processor: (String, ((UIImage) -> UIImage?))? = nil, handler: Manager.Handler? = nil) {
    ...
    func setImage(urlRequest: URLRequest, processor: (String, ((UIImage) -> UIImage?))? = nil, handler: Manager.Handler? = nil) {
    ...
    func setImage(url: URL, targetSize: CGSize, contentMode: Decompressor.ContentMode, processor: (String, ((UIImage) -> UIImage?))? = nil, handler: Manager.Handler? = nil) {
    ...
    func setImage(urlRequest: URLRequest, targetSize: CGSize, contentMode: Decompressor.ContentMode, processor: (String, ((UIImage) -> UIImage?))? = nil , handler: Manager.Handler? = nil) {
